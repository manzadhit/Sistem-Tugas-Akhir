...
@section('content')
  ...
  <div class="relative h-40 overflow-hidden rounded-xl bg-gradient-to-br from-blue-800 to-blue-500 mb-8">
    <div class="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
      <h1 class="text-2xl font-bold mb-1">Persetujuan Ketua Jurusan</h1>
      <p class="text-sm opacity-80">Tinjau dan berikan persetujuan laporan bimbingan mahasiswa tahap Hasil & Skripsi.</p>
    </div>
  </div>
  ...
  <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
    ...
    <div class="flex flex-col gap-4 border-b border-slate-200 p-5 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-slate-500">Mahasiswa yang mengajukan persetujuan laporan Hasil & Skripsi</p>
      </div>
      <form action="{{ route('kajur.persetujuan-kajur.index') }}" method="GET" class="flex items-center gap-3">
        <div class="relative">
