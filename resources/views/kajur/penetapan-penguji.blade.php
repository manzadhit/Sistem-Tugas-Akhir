                      ...
                      <div x-show="open" x-transition class="border-t border-gray-200 p-3 bg-gray-50 sm:p-4">
                        <div class="mb-4 pb-4 border-b border-dashed border-gray-300">
                          ...
                          <div
                            ...
                            <span class="text-blue-900 text-sm" x-text="formatScore(similarityScores[dosen.id])"></span>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div
                            ...
                            <span class="text-green-900 text-base" x-text="formatScore(getTotalScore(dosen.id))"></span>
                          </div>
                        </div>
                      </div>
                    </div>
