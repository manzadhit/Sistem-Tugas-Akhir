...
<x-modal name="import-dosen" :show="$showImportErrors" maxWidth="lg" focusable>
  <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between gap-3">
    <div>
      <h2 class="text-lg font-semibold text-gray-900">Import Data Dosen</h2>
      <p class="text-sm text-gray-500">Unggah file CSV, XLS, atau XLSX sesuai format yang ditentukan.</p>
    </div>
    <button type="button" x-on:click="$dispatch('close-modal', 'import-dosen')"
