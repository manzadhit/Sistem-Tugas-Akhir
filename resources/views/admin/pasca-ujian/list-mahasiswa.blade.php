...
@section('content')
  ...
  <div class="mb-8">
    ...
    <p class="mt-1 text-slate-500">Selamat datang kembali! Berikut ringkasan data Jurusan Teknik Informatika.</p>
  </div>

  {{-- Stats --}}
  <div class="grid grid-cols-1 gap-6 mb-8 sm:grid-cols-2">
    <div
      class="flex items-center gap-4 rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5">
      <div
      ...
      <div>
        <p class="text-sm text-slate-500">Mahasiswa Ajukan Hasil Ujian</p>
