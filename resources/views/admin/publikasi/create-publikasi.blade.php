...
@section('content')
  ...
  <div class="flex items-center gap-2 text-sm text-gray-500 mb-4">
    <a href="{{ route('admin.publikasi.index') }}" class="hover:text-blue-600 transition-colors">Kelola
      Publikasi</a>
  ...
  <div class="bg-gradient-to-br from-blue-800 to-blue-500 rounded-2xl p-5 sm:p-8 mb-6 text-white">
    ...
    <p class="opacity-90 text-sm">Isi data publikasi dosen Teknik Informatika</p>
  </div>
  ...
  <form method="POST" action="{{ route('admin.publikasi.store') }}">
    @csrf
        ...
        <div class="px-5 py-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div class="sm:col-span-2">
            ...
            <select name="dosen_id" required
              class="w-full pl-3 pr-8 py-2.5 border rounded-lg text-sm text-gray-800 bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 transition-all @error('dosen_id') border-red-400 bg-red-50 @else border-gray-300 @enderror">
